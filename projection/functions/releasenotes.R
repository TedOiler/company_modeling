...
p <- box(collapsible=T, title="v0.0", solidHeader=T, width=12, collapsed=T,
         ...
         div(
           ...
           p("-", strong("Input:"),  " Here you can upload a \".xlsx\" file with the expected Cost of Revenue on a monthly basis for a 2 years period"),
           p("- ", strong("Assumptions:"), " This is the most important tab. This includes in text all the logic behind the model. It is crucial for transparency
